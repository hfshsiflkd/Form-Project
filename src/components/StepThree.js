...
const StepThree = (props) => {
  ...
  const IsStepOneValid = (data) => {
    ...
    if (!profileImg || profileImg.length < 0) {
      errors.profileImg = "Please select a img.";
      isValid = false;
    }

    if (!dateBirth || dateBirth.length < 0) {
    ...
    >
      <div className="h-auto w-[480px] p-[32px] bg-white rounded-lg">
        <div className=" w-[416px]  flex justify-between flex-col">
          <div className=" w-[416px] h-[129px] flex flex-col justify-between items-start mb-3">
          ...
          <div className=" w-[416px]  flex flex-col justify-start gap-3">
            <Input
              label="dateBirth"
              name="dateBirth"
            ...
            <div className="w-[416px] flex flex-col justify-between space-y-2">
              ...
              {!SelectedImg.length > 0 ? (
                <div>
                  <div className="bg-customimgborder w-[416px] h-[180px] flex justify-center items-center py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
                      ...
                      <div className="flex items-center justify-center">
                        <label>
                          <input
                            ...
                            hidden
                          />
                          <div className="flex w-28 h-9 px-2 flex-col bg-indigo-600 rounded-full shadow text-white text-xs font-semibold  items-center justify-center cursor-pointer focus:outline-none">
                            Choose File
                          </div>
                        </label>
                      </div>
                ...
                <div className="relative">
                  <Image
                    src={SelectedImg}
                    alt="uploaded file"
                    className="object-fill w-[416px] h-[180px] z-10"
                    width={416}
                    height={180}
                  />
        ...
        <div className="w-[416px] h-[44px] mt-[20px] flex justify-between">
          <button
